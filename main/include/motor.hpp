...
#define BASE_REAR_LEFT_PWM_GPIO 32
#define BASE_REAR_LEFT_LEDC_CHANNEL LEDC_CHANNEL_2

#define BASE_FRONT_LEFT_PWM_GPIO 33
#define BASE_FRONT_LEFT_LEDC_CHANNEL LEDC_CHANNEL_4

#define BASE_REAR_RIGHT_PWM_GPIO 23
#define BASE_REAR_RIGHT_LEDC_CHANNEL LEDC_CHANNEL_3

#define BASE_FRONT_RIGHT_PWM_GPIO_2 25
#define BASE_FRONT_RIGHT_LEDC_CHANNEL_2 LEDC_CHANNEL_5
